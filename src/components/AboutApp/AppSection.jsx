    ...
    <div className={style.mainAppSection}>
      <div className={style.App_Screen1}>
        ...
        <div className={style.content}>
          ...
          Don't know how to start? Feeling confused? Try our blogs. Ophelia blogs are specially designed to guide you and help you to achieve mental peace. Read our
